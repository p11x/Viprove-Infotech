...
export function TechCtaSection() {
  return (
    <section className="relative py-24 overflow-hidden" style={{ background: 'linear-gradient(135deg, #4F46E5 0%, #7C3AED 50%, #0891B2 100%)' }}>
      <div className="absolute inset-0" style={{ animation: 'gradient-shift 8s ease infinite' }} />
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
          Let's discuss the best technology approach for your project.
        </p>
